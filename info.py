...
URL = "https://jack-reacher-wiew.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jack-reacher-wiew.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jack-reacher-wiew.onrender.com/".format(FQDN)
else:
    URL = "https://jack-reacher-wiew.onrender.com/".format(FQDN)
